...
for tNow = 5:5:10*365
  ...
  neumannConditions =   [0  ,   0,   0, Uconc*Tref, Uconc*Tref, Uconc*Tref, h*To, h*To]/kGranite;
  ...
  ab(Free) = inv(A(Free,Free)+Q(Free,Free))*b(Free);
  
  Const(Free) = inv(Vec(Free,Free))*((uLast(Free)-ab(Free)));
  
  

  u(Free) = Vec(Free,Free)*(exp(-lambda(Free)*dt).*Const(Free)) ...
	    + ab(Free);
