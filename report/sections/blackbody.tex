...
där $U$ är den totala fotonenergin i lådan och $V$ är lådans volym. Kvoten $U/V$ är alltså energitätheten hos fotonerna i lådan. Ekvationen fås ur Plancks spektrum.\cite[ss.~292,~301-302]{schroeder00} % Ev. förtydliga mer om vad som fås ur Plancks spektrum och vad U är.
