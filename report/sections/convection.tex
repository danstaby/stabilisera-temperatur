...
Slutligen sätts i \ref{eq:convection:reynolds} $B=E$ för att söka ett uttryck för energins bevarande. Med antagandet att volymen inte utför något arbete blir $E = Q$, där $Q$ betecknar värmeenergin, och på samma vis som i avsnitt
\ref{sec:heatconduction} blir $Q = c_p \rho dT$, vilket ger följande:
...
kvadratmeter. Exponenten $\eta$ sätts till 1 för att motsvara Darcys lag. Hus är dock inte så
 ...
 det 0,75.\ref{sasic} Ett sådan här test är alltså essentiellt för att få veta hur byggnaden 
 påverkas av vind.
