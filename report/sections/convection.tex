...
Betrakta åter~\eqref{eq:convection:reynolds} och sätt nu $B = m\mathbf{v}$. På samma vis som kontinuitetsekvationen~\eqref{eq:convection:continuityinc} härleddes, fås för det infinitesimala volymelementet i \emph{\color{red} figur~\ref{fig:}} sambandet
...
Första termen inom hakparentes är kontinuitetsekvationen~\eqref{eq:convection:continuity} försvinner.
...
För \emph{\color{red} flytkraftsdrivet} flöde kan det vara lämpligt att använda sig av
