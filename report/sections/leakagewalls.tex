...
Vilken kyleffekt vinden har på fastigheten är mer osäkert vid högre vindhastigheter. När vinden
 ...
 kan vara mellan några watt per Kelvin upp mot knappt trettio dito. När vi har mer normala $\unit[10]{m s^{-1}}$ ser vi istället att kyleffekten kan vara från några få upp emot $\unit[20]{W K^{-1}}$ för en byggnad i 
