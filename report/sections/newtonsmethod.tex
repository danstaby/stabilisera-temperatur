...
Om denna metod skall användas för att lösa ett ekvationssystem istället för en realvärd funktion i en dimension behöver ett mått sättas upp. Problemet som ska lösas är $\mathbf{F}(\mathbf{x}) = 0$.
