...
\begin{comment}
Genom att jämföra energiflödena under ett soligt dygn i december med ett molnigt konstateras att energiflödet kan minskas med $\unit[17]{\%}$ genom att ta hänsyn till solen en solig dag. Detta ger då en energibesparing på $\unit[4]{\%}$ över hela eldningssäsongen (se~\ref{subsec:sunhours}).
\end{comment}
