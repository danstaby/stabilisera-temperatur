...
Genom att summera alla opåverkbara energiflöden fås ett värde på hur mycket energi som behöver tillföras för att uppnå önskad inomhustemperatur.
...
ventilation. Den sista punkten, som orsakas av vind, utelämnas i ett första steg. Från fasta energikällor fås alltid ett bidrag på totalt $\unit[10,5]{kW}$, se avsnitt~\ref{sec:constsources}. Ur figurerna i avsnitt~\ref{sec:steadystatewall} får vi energiflödena per kvadratmeter genom de 
olika avsnitten av klimatskalet och med hjälp av areorna i tabell \ref{tbl:uvalue} fås det totala 
energiutflödet genom husets hela klimatskal. Flödet genom grunden fås ur figur~\ref{fig:cooling_ground} och solinstrålningen genom fönster
