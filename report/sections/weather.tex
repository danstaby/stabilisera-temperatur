...
En parameter som vi inte tar hänsyn till är snö. När snön har lagt sig på taket kan man anta att den har en isolerande effekt. Vi kan inte mäta om och i så fall hur mycket snö det ligger på taket. Enligt SMHI\cite{SMHIdata}
...
\hline
\rule{0pt}{3ex}Vindhastighet & $\unit[0\mhyphen 60]{m s^{-1}}$ & $\pm 3\mhyphen 5\%$ & $\unit[0,1]{m s^{-1}}$ \\ 
...
\rule{0pt}{3ex}Hagel &  &  & 0,1 träffar per $\unit{cm^2}$ \\
~varaktighet & & från första träffen & 10 s\\
~intensitet & & & 0,1 träffar per $\unit{cm^2}$ och timme\\
\hline
\end{tabular}
\end{center}
