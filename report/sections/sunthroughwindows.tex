...
Det beräknade g-värdet kan sedan användas för att uppskatta energiflödet genom fönstret. Anta att en pyranometer anger solstrålningsintensiteten $\unit[I_0]{W/m^2}$. Då ges det totala energiflödet Q av sambandet $Q = g \cdot A \cdot I_0\cos{\theta} \;\unit[]{W}$, där A är fönstrets area och $\theta$ är vinkeln solen bildar mot ytans normal.
