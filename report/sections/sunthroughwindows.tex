...
% Ställa upp metod eller hänvisa till färdiga program?
...
Om den azimuthala (relativt ett väderstreck i horisontalled) samt den altitudinella (vertikala relativt horisonten) vinkeln tillhandahålls som $\alpha$ respektive $\beta$ (i radianer) fås vinkeln, i grader, relativt fönstrets normal av:

\begin{equation} 
\theta = \frac{360}{2\pi}\arctan{\left( \sqrt{\tan{\alpha}^2 + \tan{\beta}^2} \right)}
\end{equation}

% Beräkna för vilka vinklar skuggor faller över fönstren

% Gardiner och persienner förändrar situationen, kolla källan nedan
\begin{comment}
Simmler & Binder
