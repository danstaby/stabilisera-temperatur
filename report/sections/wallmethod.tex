...
Vid statiskt värmeflöde kommer temperaturderivatan med avseende på tiden att vara noll. Detta innebär att värmeledningsekvationen, \eqref{eq:conduction:heateq}, övergår i Laplaces ekvation $\Delta T = 0$. I en dimension blir detta $d^2T/dx^2 = 0$ vilket innebär att lösningen blir ett polynom av första ordningen.  
...
\noindent
För att göra beräkningarna enklare ser vi väggen som en oändligt stor skiva. Detta innebär att ekvationen kan skrivas i en dimension. Med hjälp av det härledda sambandet i avsnitt \ref{sec:heatconduction} kan ett ekvationssystem bildas.
