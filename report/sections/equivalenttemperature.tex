...
Strålningen från omgivningen en klar dag kan enligt \cite{bb_atmosphere} skrivas som 
\begin{equation}
I_\text{atmosfär}=\sigma\cdot T_\text{ute}^4(1-c \cdot e^{-d(273-T_\text{ute})^2})
\end{equation}
där $c=0,261$ och $d=7,77\cdot10^{-4}$ kommer ur statistiska data. En helt molnig dag kan atmosfärens temperatur $T_\text{ute}$, det vill säga $c=0$. Omgivningens strålning fås sedan, enligt avsnitt \ref{sec:bb_sur} som 38\% från atmosfärer och resterande från omgivningen, som antas ha utomhustemperatur.
