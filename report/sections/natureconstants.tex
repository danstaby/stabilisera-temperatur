...
% (källa: http://www.engineeringtoolbox.com/air-properties-d\_156.html) (för torr luft).
...
% Undersök det där med molantalet.
...
För att bestämma den dynamiska viskositeten kan Sutherlands formel användas. %\emph{(källa: wikipeida som hänvisar till Alexander J. Smits, Jean-Paul Dussauge Turbulent shear layers in supersonic flow, Birkhäuser, 2006, ISBN 0387261400 p. 46)}
