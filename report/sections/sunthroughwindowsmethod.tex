...
\begin{equation}
\frac{Q}{Q_\text{H}} = \frac{(1-p)\cdot Q_\text{H} + p\cdot Q_\text{L}}{Q_\text{H}} = 1-p + p+p\frac{Q_\text{L}}{Q_\text{H}}.
\end{equation}
