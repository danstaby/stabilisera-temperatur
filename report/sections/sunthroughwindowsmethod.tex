...
\begin{equation}
\left( D/D_0 \right)^2 = 1,00011 + 34,221\cdot 10^{-3}\cdot \cos{\left(x\right)} + 1,28\cdot 10^{-3}\cdot \sin{\left(x\right)} + 0,719\cdot 10^{-3}\cdot \cos{\left(2x\right)} + 77\cdot 10^{-6}\cdot \sin{\left(2x\right)}
\end{equation}
