...
Med dessa samband tillgängliga kan effektflödet på grund av solstrålning genom fönster beräknas, vilket kan göras med matlab-funktionerna \textit{gvalue} samt \textit{effekt} från appendix \ref{app:sunwindows}. Nödvändiga argument för dessa funktioner är fönstrets area, %vilken area?
g-värde vid vinkelrätt infallande strålning % g0?
samt konstanterna p och q från \eqref{eq:gconstants}. % Repetera värden/ekvation?
