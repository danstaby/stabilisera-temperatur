...
Vi menar dock att formen på hastighetsflödet kan anses vara av rätt karaktär och visar på hur luften rör sig vid husväggen. Också det generella formen av konvektionsparametern, som alltså beskriver hur mycket luften vid väggen rörs om, i förhållande till de andra storheterna, i figur \ref{fig:konv_param}, kan anses vara korrekt.
...
$\unit[1,18]{ Wm^{-2}K^{-1}}$.} \textbf{\color{red} Vad för vägg har 1,18 i U-värde?}     

\end{figure}

% RESULTAT
I figur \ref{fig:h_reftemp} syns att konvektionsparametern, omrörningen, ökar med ökad utomhustemperatur. Vidare minskar den då den så kallade penaltyparametern ökar, se figur \ref{fig:h_penalty} och ökar med den volymetriska expansionskoefficienten, se figur \ref{fig:h_volexp}. \emph{\color{red} Vad innebär penaltyparametern? Vad säger det att h ökar med volymetriska expansionskoefficienten? Varför har vi valt de här storheterna?}
