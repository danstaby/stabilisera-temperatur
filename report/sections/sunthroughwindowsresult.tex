...
\subfloat[\label{fig:windowconductionapr}
Energiflöde från värmeledning och konvektion en dag i april.]{
\includegraphics[width=6cm]{images/heatcond_apr.eps}}\vspace{1cm}
\subfloat[\label{fig:windowconductiondec}
Energiflöde från värmeledning och konvektion en dag i december.]{
\includegraphics[width=6cm]{images/heatcond_dec.eps}
}
