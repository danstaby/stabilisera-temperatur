...
\centering
\subfloat[
	Söderväggen tillika västerväggen, utifrån och in från vänster till höger. Alla mått är i mm.
	]{
	\parbox[c]{7cm}{
	\centering
	\raisebox{0.5cm}{
...
\subfloat[Norrväggen, utifrån och in från vänster till höger. Alla mått är i mm.]{
	\parbox[c]{7cm}{
	\centering
