...
Vi använder genomgående payoff metoden för att visa hur snabbt en investering betalar sig, det är en inte helt rättvisande metod, då det inte framgår vilken man kan spara mest pengar på, utan vilken som betalar sig snabbast. Det finns inget restvärde för någon av investeringarna.
...
\paragraph{Ekonomi}
Vi har inte räknat på en isolering inifrån då det inte har varit möjligt att få en offert eller prisförslag på ett sådant arbete. Det är inte heller möjligt att göra på grund av de boendes preferenser.
