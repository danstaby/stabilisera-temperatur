...
Då det finns en stor yta på huset som rent teoretiskt skulle kunna få ett bättre U-värde, det handlar om ca XXX m2, vilket är YYY procent av ytan runt där energi kan ledas ut. [Länka till inledning].
...
\subsubsection{Tilläggsisolering utifrån}
...
\subsubsection{Tilläggsisolering inifrån}
