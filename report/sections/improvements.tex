...
Vi använder genomgående payoff metoden för att visa hur snabbt en investering betalar sig, det är en inte helt rättvisande metod, då det inte framgår vilken man kan spara mest pengar på, utan vilken som betalar sig snabbast. Det finns inget restvärde för någon av investeringarna. Då approximationerna är väldigt grova när det uppskattas hur många procent man kan spara av vissa åtgärder, så finns det ingen större anledning att göra kalkyler bättre, då dem bygger på approximationerna.
